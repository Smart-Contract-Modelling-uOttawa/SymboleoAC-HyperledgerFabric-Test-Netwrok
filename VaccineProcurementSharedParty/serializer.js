   ...
   function deserialize(data) {
     ...
     contract = new VaccineProcurementSharedParty(object.pfizerP,object.buyerP,object.regulatorP,object.adminP,object.fdaP,object.worldcourierP,object.approval,object.unitPrice,object.minQuantity,object.maxQuantity)
   ...
   if (object.obligations.oAgreedOnRequest != null) {
       const obligation = new Obligation('oAgreedOnRequest', contract.pfizer, contract.buyer, contract)
   ...
   if (object.obligations.oDeliver != null) {
       const obligation = new Obligation('oDeliver', contract.buyer, contract.pfizer, contract)
   ...
   if (object.obligations.oAssign != null) {
       const obligation = new Obligation('oAssign', contract.pfizer, contract.buyer, contract)
   ...
   if (object.obligations.oRequestVaccineDosage != null) {
       const obligation = new Obligation('oRequestVaccineDosage', contract.pfizer, contract.buyer, contract)
     ...
     if (object.survivingObligations.oPay != null) {
       const obligation = new Obligation('oPay', contract.pfizer, contract.buyer, contract,null, true)
     ...
     if (object.survivingObligations.oWithdrewApproval != null) {
       const obligation = new Obligation('oWithdrewApproval', contract.buyer, contract.pfizer, contract,null, true)
     ...
     if (object.powers.pStopWork != null) {
       const power = new Power('pStopWork', contract.buyer, contract.buyer, contract)
   ...
   const contractList=['regulator','admin','pfizer','buyer','fda','worldcourier','requested','leadtimeINform','notifiedOD','delivered','invoiced','paid','confirmed','lawStopWork','regulationStopWork','judicialStopWork','adminStopWork','govStopWork','vaccineDose','agreedFromG','outsideRisk','remain','paidAmount','withdrewApproval','buyerTerminateAgreement','pfizerTerminateAgreement','temperature','humidity','shock','lightExposure','sealOpen','accessPolicy']  
