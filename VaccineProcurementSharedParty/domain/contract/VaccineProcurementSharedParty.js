  ...
  class VaccineProcurementSharedParty extends SymboleoContract {
    constructor(pfizerP, buyerP, regulatorP, adminP, fdaP, worldcourierP, approval, unitPrice, minQuantity, maxQuantity) {
      super("VaccineProcurementSharedParty")
      this._name = "VaccineProcurementSharedParty"
...
this.worldcourier.dept._value = this.worldcourierP.dept
      ...
      this.requested.addPerformer(this.buyer)
this.requested.addController(this.buyer)
...
this.delivered.addController(this.pfizer)
      ...
      this.invoiced.addPerformer(this.buyer)
this.invoiced.addController(this.buyer)
...
this.paid.addController(this.buyer)
      ...
      this.confirmed.addPerformer(this.buyer)
this.confirmed.addController(this.buyer)
      		this.lawStopWork = new StopWork("lawStopWork")
      
      this.lawStopWork.addPerformer(this.buyer)
this.lawStopWork.addController(this.buyer)
...
this.adminStopWork.addController(this.regulator)
      ...
      this.govStopWork.addPerformer(this.buyer)
this.govStopWork.addController(this.buyer)
...
this.vaccineDose.owner = this.pfizer
      ...
      this.agreedFromG.addPerformer(this.buyer)
this.agreedFromG.addController(this.buyer)
...
this.remain.owner = this.buyer
       this.remain.addController(this.buyer)  
      		this.paidAmount = new PaidAmount("paidAmount")
      
this.paidAmount.value._value = 0
this.paidAmount.owner = this.buyer
       this.paidAmount.addController(this.buyer)  
...
this.withdrewApproval.addController(this.fda)
      		this.buyerTerminateAgreement = new TerminateAgreementG("buyerTerminateAgreement")
      
      this.buyerTerminateAgreement.addPerformer(this.buyer)
this.buyerTerminateAgreement.addController(this.buyer)
...
this.addController(this.buyer); 
      // create instance of triggered obligations
          	  ...
          	  this.oRequestVaccineDosageSituation.addConsequentOf({_type: 'eventCondition', resource:"buyerTerminateAgreement", resourceType:"TerminateAgreementG"} )
        ...
        this.obligations.oRequestVaccineDosage = new Obligation('oRequestVaccineDosage', this.pfizer, this.buyer, this, this.oRequestVaccineDosageSituation)
      
      this.survivingObligations.oWithdrewApproval = new Obligation('oWithdrewApproval', this.buyer, this.pfizer, this,null, true)
      
    
this.accessPolicy.addRulee("grant", "read", this.vaccineDose, this.buyer, this.pfizer)
this.accessPolicy.addRulee("grant", "read", this.vaccineDose.FDAapproval, this.worldcourier, this.pfizer)
this.accessPolicy.addRulee("grant", "read", this.delivered, this.buyer, this.pfizer)
...
this.accessPolicy.addRulee("grant", "read", this.withdrewApproval, this.pfizer, this.fda)
  ...
  module.exports.VaccineProcurementSharedParty = VaccineProcurementSharedParty
