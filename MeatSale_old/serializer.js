...
function deserialize(data) {
  ...
  const contract = new MeatSale(object.buyer,object.seller,object.qnt,object.qlt,object.amt,object.curr,object.payDueDate,object.delAdd,object.effDate,object.delDueDateDays,object.interestRate, object.userList)
  
  contract.state = object.state
  contract.activeState = object.activeState

  //AC for genrating certificate, name is enrollmenet ID
  //method 2 - userList needs to be updated
